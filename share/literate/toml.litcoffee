...
To make the library available to JS code outside the browser we need to attach an appropriately named object to the global object, which in browsers in _window_.
